...
public class PromotionMove extends Move {
    ...
    public PromotionMove(byte start, byte end, byte type) {
        startSquare=start;
        endSquare=end;
        preScore=(PreCompute.pieceValues[type&7]/10-1)*1000;
        newPieceType=type;
        if (type<16) {
    ...
    public boolean equals(Object m) {
        return getClass() == m.getClass() && equals((PromotionMove) m);
    }
    public boolean equals(PromotionMove m) {
        return (startSquare==m.startSquare && endSquare==m.endSquare && newPieceType==m.newPieceType);
    }
